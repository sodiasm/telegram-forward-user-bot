...
* update API calls to use 'peer' instead of 'channel' in GetForumTopics ([30f3fd3](https://github.com/PetroVoronov/telegram-forward-user-bot/commit/30f3fd3d2a87b343cd2661a422af9a0286a99732))
